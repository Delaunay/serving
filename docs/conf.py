#!/usr/bin/env python
"""
serving documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "serving"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import serving.core  # noqa
...
project = "serving"
_full_version = serving.core.__version__
author = serving.core.__author__
copyright = serving.core.__copyright__
